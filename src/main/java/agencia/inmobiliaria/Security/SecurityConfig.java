...
public class SecurityConfig {
    ...
    SecurityFilterChain securityFilterChain(HttpSecurity http, JWTValidationFilter jwtValidationFilter)
        ...
        http.authorizeHttpRequests(auth -> auth
                ...
                .requestMatchers(HttpMethod.GET, "/inmueblePorAlquilerOVenta").hasAnyRole("USER", "ADMIN")
                .requestMatchers(HttpMethod.GET, "/buscarPorNumeroReferencia/{numeroReferencia}").hasAnyRole("USER", "ADMIN")
