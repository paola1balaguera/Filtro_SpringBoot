package agencia.inmobiliaria.Security;
...
public class SecurityConfig {
    ...
    SecurityFilterChain securityFilterChain(HttpSecurity http, JWTValidationFilter jwtValidationFilter)
        ...
        http.authorizeHttpRequests(auth -> auth
                ...
                .requestMatchers(HttpMethod.GET, "/oficinas/").hasAnyRole("USER", "ADMIN")
                .requestMatchers(HttpMethod.GET, "/inmuebles/").hasAnyRole("USER", "ADMIN")
                .requestMatchers(HttpMethod.GET, "/inmuebles/inmueblePorAlquilerOVenta").hasAnyRole("USER", "ADMIN")
                .requestMatchers(HttpMethod.GET, "/inmuebles/buscarPorNumeroReferencia/{numeroReferencia}").hasAnyRole("USER", "ADMIN")
                .requestMatchers( "/zonas/**", "/visitaInmuebles/**","/TipoEstancias/**","/oficinas/**","inmuebles/**","/clientes/**","/ciudades/**").hasRole("ADMIN")
                .anyRequest().denyAll())
        ...
        http.csrf(csrf -> csrf
                ...
                .ignoringRequestMatchers("/authenticate","/h2-console","/zonas/**", "/visitaInmuebles/**","/TipoEstancias/**","/oficinas/**","inmuebles/**","/clientes/**","/ciudades/**")
